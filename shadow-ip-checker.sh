...
banner() {
    echo "  ____   ___   ___     ____   _  __  ___   ____  ____  __       __"
    echo " |___ \| ___| ( _ )  / ___/ / / /  /   |  / __ \/ __ \| |      / /"
    echo "   __) |___ \ / _ \  \__ \ / /_/  / /| | / / / / / / /| |  /| / / "
    echo "  / __/ ___) | (_) \ ___/ /  __  / ___ |/ /_/ / /_/ / | |_/ |/ /  "
    echo " |_____|____/ \___/ /____/__/ /_/_/  |_/_____/\____/  |__/\___/   "
    echo " " | tr -d '\n'; printf "#%.0s" {1..50}; echo
    echo "Created By 258/SHADOW INC.( 258/Team )"
}
...
myipaddr() {
    ...
    printf "\e[0m\n"
    read -p $'  \e[1;31m>>\e[0m\e[1;96m  ' mainorexit1
...
useripaddr() {
    ...
    printf "\e[0m\n"
    printf "\e[0m\n"
    read -p $'  \e[1;31m[\e[0m\e[1;37m~\e[0m\e[1;31m]\e[0m\e[1;92m Input IP Address \e[0m\e[1;96m: \e[0m\e[1;93m' useripaddress
    ...
    printf "  \e[0m\e[1;91m[\e[0m\e[1;97m02\e[0m\e[1;91m]\e[0m\e[1;93m Exit\e[0m\n"
    printf "\e[0m\n"
    read -p $'  \e[1;31m>>\e[0m\e[1;96m  ' mainorexit2
